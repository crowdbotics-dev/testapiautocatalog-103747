...
## Project Structure
    ...
    ├── testapiautocatalog_103747  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_103747`
...
2. Clone this repo and `cd testapiautocatalog_103747`
